...
'use strict';
(function(d, r) {
    "object" === typeof exports && "undefined" !== typeof module ? r(exports) : "function" === typeof define && define.amd ? define(["exports"], r) : (d = d || self,
    r(d.React = {}))
}
)(this, function(d) {
    function r(a) {
    ...
    function O(a, b, c, g) {
        ...
        else if (null === a || "object" !== typeof a ? h = null : (h = la && a[la] || a["@@iterator"],
    ...
    function za(a, b, c) {
        ...
        Array.isArray(a) ? R(a, g, c, function(a) {
            return a
        }) : null != a && (N(a) && (a = va(a, e + (!a.key || b && b.key === a.key ? "" : ("" + a.key).replace(ma, "$&/") + "/") + c)),
        g.push(a))
    }
    ...
    var M = {
        current: null
    }, ha = Object.prototype.hasOwnProperty, ia = {
        key: !0,
        ref: !0,
        __self: !0,
        __source: !0
    ...
    if ("undefined" === typeof window || "function" !== typeof MessageChannel) {
        ...
        B.port1.onmessage = function() {
            if (null !== K) {
                ...
                ua = a + ta;
                try {
                    K(!0, a) ? aa.postMessage(null) : (J = !1,
                    K = null)
                } catch (b) {
                    throw aa.postMessage(null),
                    b;
                }
            } else
                J = !1
    ...
    I(B, {
        Scheduler: {
            ...
            unstable_scheduleCallback: function(a, b, c) {
                ...
                e > d ? (a.sortIndex = e,
                S(u, a),
                null === n(p) && a === n(u) && (y ? V() : y = !0,
                G(T, e - d))) : (a.sortIndex = c,
                S(p, a),
                v || H || (v = !0,
                z(U)));
                return a
    ...
    d.cloneElement = function(a, b, c) {
        ...
        if (null != b) {
            ...
            for (k in b)
                ha.call(b, k) && !ia.hasOwnProperty(k) && (d[k] = void 0 === b[k] && void 0 !== h ? h[k] : b[k])
        }
