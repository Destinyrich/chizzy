!function() {
    ...
    function y(e) {
        return Object.keys(e).filter((t=>!!e[t] && -1 === p.indexOf(t)))
    }
    function b(e) {
        l = e
    }
    ...
    function P(e, t, n) {
        let o;
        x ? (o = document.createEvent("CustomEvent"),
        o.initCustomEvent(e, !0, !0, n)) : o = new CustomEvent(e,{
            detail: n
        }),
    ...
    function L(e, t) {
        let n;
        return e.nodeType === Node.TEXT_NODE ? n = document.createTextNode(e.content) : e.nodeType === Node.COMMENT_NODE ? n = document.createComment(e.content) : (n = document.createElement(e.tag),
        e && e.attributes instanceof NamedNodeMap ? Array.prototype.forEach.call(e.attributes, (e=>{
            C(n, e.name, e.value)
        }
    ...
    const S = e=>!e.id
      , _ = e=>{
        var t, n;
        return !(null != (t = e.tag) && null != (n = t.pages) && n.length)
    }
      , G = (e,t)=>{
        var n, o;
        return (null == (n = e.tag) || null == (o = n.pages) ? void 0 : o.includes(t.id || "")) || !1
    }
    ;
    function j(e, t) {
            ...
            const t = e.tag
              ...
              , i = function(e, t, n, o) {
                ...
                e.forEach((e=>{
                    ...
                    i.push(t),
                    o ? n.insertBefore(t, d) : n.appendChild(t)
                }
                )),
                0 === r && v(t.onload, {}, !0);
                return i
            }(n, {
                onload: N(O.TAG_LOADED, t.name, t, A),
                onerror: N(O.TAG_LOAD_ERROR, t.name, t, T)
    ...
    function H(e, t) {
        const r = o(e)
          , {currentPageID: a, initConsentPolicyManager: c=!1} = t;
        var d, s, l, g;
        if (r.errors && r.errors.length > 0 && n(JSON.stringify(r.errors)),
        r.config && ((s = r.config.consentPolicy) && "object" == typeof s && (p = [...p, ...y(s)]),
        c && window.consentPolicyManager && window.consentPolicyManager.init({
            consentPolicy: r.config.consentPolicy
        }),
        "object" != typeof (d = r.config) || Array.isArray(d) || (w = {
            ...w,
            ...d
        })),
        r.tags) {
            l = r.tags,
            i(null == (g = w) ? void 0 : g.experiments, u) ? l.forEach((e=>{
                var t;
    ...
    function J(e) {
        const {metasiteId: t, htmlsiteId: o, baseUrl: i, wixSite: r, language: a, categories: c} = e
          , s = q(i, t, r)
          , u = !r && window.consentPolicyManager ? window.consentPolicyManager._getConsentPolicyHeader() : {}
          , l = function(e) {
          ...
          , g = function(e, t) {
            ...
            let n = t.split(e + "=")[1];
            return n = n ? decodeURIComponent(n.split("&")[0]) : void 0,
            n
        }("omit")
          , f = window.wixEmbedsAPI.getAppToken;
        f && (u.authorization = v(f, d)),
        U(s, (e=>{
            H(e, {
            ...
            n("Error loading site tags at " + s),
            n(e.message)
        }
        ), {
            query: {
    ...
    let X = ()=>{
        ...
        window.wixEmbedsAPI.registerToEvent("pageNavigation", Y),
        document.addEventListener("consentPolicyChanged", V),
        window.wixTagManager = W,
        P(O.TAG_MANAGER_LOADED, window, W)
    }
    ;
    window.wixEmbedsAPI && "function" == typeof window.wixEmbedsAPI.registerToEvent ? X() : window.addEventListener("wixEmbedsAPIReady", (()=>{
        X(),
        X = function() {}
    }
    ), !1)
