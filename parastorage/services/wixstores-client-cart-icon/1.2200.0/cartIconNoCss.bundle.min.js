!function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e(require("react")) : "function" == typeof define && define.amd ? define(["react"], e) : "object" == typeof exports ? exports.cartIconNoCss = e(require("react")) : t.cartIconNoCss = e(t.React)
}("undefined" != typeof self ? self : this, (function(t) {
    return function() {
        var e = {
            7874: function(t, e, r) {
                const {component: n} = r(7110);
                t.exports = {
                    default: {
                        component: n
                    }
            ...
            7110: function(t, e, r) {
                ...
                class f extends a().Component {
                    constructor(t) {
                        if (super(t),
                        u()(this, "textRef", void 0),
                        t.aspectRatio) {
                            const e = t.aspectRatio * t.initialViewBoxHeight;
                            this.state = {
                                textLength: e - t.initialViewBoxWidth,
                                width: e
                            }
                        } else
                            this.state = {
                                textLength: 0,
                                width: t.initialViewBoxWidth
                            };
                        this.textRef = a().createRef()
                    }
                    componentDidMount() {
                        this.props.aspectRatio || this.build()
                    }
                    componentDidUpdate(t) {
                        t.text !== this.props.text && this.build()
                    }
                    build() {
                        const t = this.textRef.current.getComputedTextLength()
                          , e = this.props.initialViewBoxWidth + t;
                        this.setState({
                            textLength: t,
                            width: e
                        })
                ...
                class y extends a().PureComponent {
                    ...
                    componentDidMount() {
                        setTimeout(this.resizeFrame, 0)
                    }
                    componentDidUpdate(t) {
                        this.props.text === t.text && this.props.containerWidth === t.containerWidth || this.resizeFrame()
                    }
                    async resizeFrame() {
                        const t = this.calculateProportion()
                          , e = Math.round(100 * this.props.containerHeight / t)
                          , r = Math.round(this.props.containerWidth * t / 100);
                        await this.props.resizeComponent(e, r)
                    }
                    render() {
                        const t = this.calculateProportion()
                          , e = this.props.preserveAspectRatio ? {
                    ...
                    calculateProportion() {
                        const [,,t,e] = this.props.viewBox.split(" ");
                        return parseFloat(e) / parseFloat(t) * 100
                    }
                }
                var x = {
                    cartIconDefaults: "rToVUj",
                    cartIconButtonContainer: "i1GPOs",
                    quantity: "bGBBgJ",
                    withoutBackground: "jDuYHa",
                    bubble: "l7HJaJ",
                    "cart-icon-1": "n7lAn9",
                    cartIcon1: "n7lAn9",
                    dozens: "h4oe9D",
                ...
                const E = {
                    Icon1: t=>a().createElement(y, p()({
                        ...
                        dy: ".35em",
                        textAnchor: "middle",
                        className: t.s.quantity,
                        "data-hook": "items-count"
                    }, t.count)),
                    Icon2: t=>a().createElement(y, p()({
                        ...
                        "data-hook": "items-count",
                        className: h()(t.s.quantity, t.s.withoutBackground),
                        textAnchor: "middle",
                        x: "116",
                        y: "35",
                        dy: ".48em"
                    }, t.count)),
                    Icon3: t=>a().createElement(f, {
                        initialViewBoxWidth: 120,
                        initialViewBoxHeight: 105,
                        text: t.text,
                        aspectRatio: t.aspectRatio
                    }, (e=>{
                        let {width: r, height: n, textRef: o, textLength: i} = e;
                    ...
                    Icon4: t=>a().createElement(f, {
                        initialViewBoxWidth: 0,
                        initialViewBoxHeight: 105,
                        text: t.text,
                        aspectRatio: t.aspectRatio
                    }, (e=>{
                        let {width: r, height: n, textRef: o} = e;
                        return a().createElement(y, p()({
                            viewBox: "0 0 " + r + " " + n,
                            preserveAspectRatio: !0
                        }, t), a().createElement("text", {
                            x: "0",
                            y: "83",
                            ref: o,
                            "data-hook": "free-text"
                        }, t.text + " ", a().createElement("tspan", {
                            className: h()(t.s.quantity, t.s.withoutBackground),
                            "data-hook": "items-count"
                        }, "(", t.count, ")\u200f")))
                    }
                    )),
                    Icon5: t=>a().createElement(f, {
                    ...
                    Icon7: t=>a().createElement(f, {
                        initialViewBoxWidth: 140,
                        initialViewBoxHeight: 200,
                        text: t.text,
                        aspectRatio: t.aspectRatio
                    }, (e=>{
                        let {width: r, height: n, textLength: o, textRef: i} = e;
                        return a().createElement(y, p()({
                            viewBox: "0 0 " + r + " " + n,
                            preserveAspectRatio: !1
                        }, t), a().createElement("g", {
                    ...
                    Icon8: t=>a().createElement(y, p()({
                        viewBox: "221.4 359.3 267 123",
                        preserveAspectRatio: !1
                    }, t), a().createElement("rect", {
                        x: "221.4",
                        y: "403.7",
                        width: "152.4",
                        height: "6"
                ...
                class v extends a().Component {
                    constructor(t) {
                        super(t),
                        u()(this, "anchorRef", void 0),
                        this.anchorRef = a().createRef(),
                    ...
                    componentDidUpdate(t) {
                        this.props.triggerFocus !== t.triggerFocus && this.triggerFocus()
                    }
                    reportAppLoaded() {
                    ...
                    renderIcon(t, e, r) {
                        const n = E["Icon" + t]
                          , {viewMode: o, dimensions: {width: i, height: s}} = this.props.host
                          , c = "Site" === o ? i / s : void 0;
                    ...
                    onClick(t) {
                        t.preventDefault(),
                        this.props.isNavigate || t.stopPropagation(),
                        this.safeRun(this.props.onIconClick)
                    }
                    resizeComponent(t, e) {
                        return "Editor" === this.props.host.viewMode ? (r = {
                            width: null,
                            height: e,
                            mobileResize: !0
                        },
                        new Promise(((t,e)=>{
                            window.Wix.resizeComponent(r, t, e)
                        }
                        ))) : Promise.resolve();
                        var r
                    }
                    ...
                    safeRun(t) {
                        this.props.isInteractive && "function" == typeof t && t()
                    }
                    componentKey() {
                        const {host: {style: {styleParams: {fonts: t}}}} = this.props;
                        return "cart-icon-" + b()(JSON.stringify(t))
                    }
                    render() {
                        if (!this.props.isLoaded)
                            return null;
                        const {ariaLabelLink: t, cartLink: e, count: r, displayText: n, isNavigate: o} = this.props
                          , {style: i} = this.props.host
                          , s = i && i.styleParams.numbers.cartWidgetIcon || 1
                          , c = h()(x.cartIconDefaults, x["cart-icon-" + s], x.cartIconButtonContainer, {
                            [x.dozens]: r >= 10 && r <= 99,
                            [x.hundreds]: r >= 100
                        });
                        return a().createElement("a", {
                            ...
                            ref: this.anchorRef,
                            role: o ? "link" : "button"
                        }, this.renderIcon(s, r, n))
                    }
                }
                var R, A, _, C, w, I, T, O, S, L;
                !function(t) {
                ...
                function(t) {
                    t.CART_COMMANDS_URL = "/_api/wix-ecommerce-renderer-web/store-front/cart/{commandName}",
                    t.NODE_GRAPHQL_URL = "_api/wixstores-graphql-server/graphql",
                    t.READ_WRITE_GRAPHQL_URL = "_api/wix-ecommerce-graphql-web/api",
                    t.STOREFRONT_GRAPHQL_URL = "_api/wix-ecommerce-storefront-web/api",
                ...
                function(t) {
                    ...
                    t.USE_LATEST_SUBDIVISIONS = "specs.stores.UseLatestSubdivisionsClient"
                }(L || (L = {}));
                var B, P, N, U, D;
                !function(t) {
                ...
                var M = "https://31e500c94d2042ff81a38a0e4a2873b7@sentry.io/1252955"
                  , k = "https://337a342c302c4c0e8c26e425e74da4c1@sentry.io/1363752"
                  , z = ((D = {})[R.ADD_TO_CART] = {
                ...
                const G = (H = function(t, e) {
                    var r = [].concat(e.cssPath || [])
                      , n = [].concat(e.rtlCssPath || [])
                      , o = [].concat(e.ltrCssPath || [])
                      , a = n.length
                      , c = function(e) {
                        var c = e.isRTL
                          , u = e.host
                          ...
                          , p = s.useMemo((function() {
                            return r.concat(c ? n : o)
                        }
                        ), [c])
                          , d = s.useState((function() {
                            var t = 0;
                            if (!z())
                                return t;
                            for (var e = 0, r = Array.from(document.styleSheets); e < r.length; e++) {
                                var n = r[e];
                                if ("string" == typeof n.href) {
                                    var o = n.href.replace(l || "", "");
                                    p.includes(o) && t++
                                }
                            }
                            return t
                          ...
                          , h = d[0]
                          , f = d[1]
                          , m = (null == u ? void 0 : u.id) || e.id
                          , y = m ? ".".concat(m) : ""
                          , x = h + s.useMemo((function() {
                            return z() ? document.querySelectorAll("".concat(y, " link")).length : p.length
                        }
                        ), []) >= p.length;
                        return s.createElement("div", {
                            className: m
                        }, l && a ? p.map((function(t) {
                            return s.createElement("link", {
                                href: "".concat(l).concat(t),
                                rel: "stylesheet",
                                type: "text/css",
                                key: t,
                                onLoad: g
                        ...
                        )) : null, a && x ? s.createElement(t, i({}, e)) : null, !a && s.createElement(t, i({}, e)));
                        function g() {
                            f((function(t) {
                                return t + 1
                            }
                    ...
                    return c.displayName = "WithStyles",
                    c.tokenForCiPoliceRule = "e2425ecc-e4c1-474c-9e2b-8357f32c907b",
                    c
                }((W = v,
                function(t) {
                    return s.createElement(s.StrictMode, null, s.createElement(W, i({}, t)))
                }
                ), {
                    strictMode: !0
                }),
                ...
                function(t) {
                    ...
                    return o(e, t),
                    e.prototype.getLazySentry = function() {
                        return new this.props.host.LazySentry(i(i({
                            dsn: j.dsn
                        }, j.config), {
                    ...
                    ,
                    e.prototype.getRavenUserContextOverrides = function() {
                        return this.props.ravenUserContextOverrides
                    }
                    ,
                    e.prototype.componentDidCatch = function(t) {
                        null === this.state.error && this.setState({
                            error: t
                        });
                        var e = this.getLazySentry();
                        if (e) {
                            j.tags && e.configureScope((function(t) {
                                Object.keys(j.tags).forEach((function(e) {
                                    t.setTag(e, j.tags[e])
                                }
                                ))
                            }
                            ...
                            (j.userContext || r) && e.configureScope((function(t) {
                                t.setUser(i(i({}, j.userContext), r))
                            }
                            )),
                    ...
                    e.prototype.render = function() {
                        return this.state.error && F ? s.createElement(F, i({
                            error: this.state.error
                        }, this.props)) : s.createElement(H, i({}, this.props))
                    }
                    ,
                    e
                }(s.Component));
 ...
 */
            ...
            1981: function(t, e, r) {
                ...
                (a = function(t, e) {
                    ...
                    for (var r = n.bytesToWords(t), c = 8 * t.length, u = 1732584193, l = -271733879, p = -1732584194, d = 271733878, h = 0; h < r.length; h++)
                    ...
                    for (h = 0; h < r.length; h += 16) {
                        var g = u
                          ...
                          , E = p
                          , v = d;
                        u = f(u, l, p, d, r[h + 0], 7, -680876936),
                        d = f(d, u, l, p, r[h + 1], 12, -389564586),
                        p = f(p, d, u, l, r[h + 2], 17, 606105819),
                        l = f(l, p, d, u, r[h + 3], 22, -1044525330),
                        u = f(u, l, p, d, r[h + 4], 7, -176418897),
                        d = f(d, u, l, p, r[h + 5], 12, 1200080426),
                        p = f(p, d, u, l, r[h + 6], 17, -1473231341),
                        l = f(l, p, d, u, r[h + 7], 22, -45705983),
                        u = f(u, l, p, d, r[h + 8], 7, 1770035416),
                        d = f(d, u, l, p, r[h + 9], 12, -1958414417),
                        p = f(p, d, u, l, r[h + 10], 17, -42063),
                        l = f(l, p, d, u, r[h + 11], 22, -1990404162),
                        u = f(u, l, p, d, r[h + 12], 7, 1804603682),
                        d = f(d, u, l, p, r[h + 13], 12, -40341101),
                        p = f(p, d, u, l, r[h + 14], 17, -1502002290),
                        u = m(u, l = f(l, p, d, u, r[h + 15], 22, 1236535329), p, d, r[h + 1], 5, -165796510),
                        d = m(d, u, l, p, r[h + 6], 9, -1069501632),
                        p = m(p, d, u, l, r[h + 11], 14, 643717713),
                        l = m(l, p, d, u, r[h + 0], 20, -373897302),
                        u = m(u, l, p, d, r[h + 5], 5, -701558691),
                        d = m(d, u, l, p, r[h + 10], 9, 38016083),
                        p = m(p, d, u, l, r[h + 15], 14, -660478335),
                        l = m(l, p, d, u, r[h + 4], 20, -405537848),
                        u = m(u, l, p, d, r[h + 9], 5, 568446438),
                        d = m(d, u, l, p, r[h + 14], 9, -1019803690),
                        p = m(p, d, u, l, r[h + 3], 14, -187363961),
                        l = m(l, p, d, u, r[h + 8], 20, 1163531501),
                        u = m(u, l, p, d, r[h + 13], 5, -1444681467),
                        d = m(d, u, l, p, r[h + 2], 9, -51403784),
                        p = m(p, d, u, l, r[h + 7], 14, 1735328473),
                        u = y(u, l = m(l, p, d, u, r[h + 12], 20, -1926607734), p, d, r[h + 5], 4, -378558),
                        d = y(d, u, l, p, r[h + 8], 11, -2022574463),
                        p = y(p, d, u, l, r[h + 11], 16, 1839030562),
                        l = y(l, p, d, u, r[h + 14], 23, -35309556),
                        u = y(u, l, p, d, r[h + 1], 4, -1530992060),
                        d = y(d, u, l, p, r[h + 4], 11, 1272893353),
                        p = y(p, d, u, l, r[h + 7], 16, -155497632),
                        l = y(l, p, d, u, r[h + 10], 23, -1094730640),
                        u = y(u, l, p, d, r[h + 13], 4, 681279174),
                        d = y(d, u, l, p, r[h + 0], 11, -358537222),
                        p = y(p, d, u, l, r[h + 3], 16, -722521979),
                        l = y(l, p, d, u, r[h + 6], 23, 76029189),
                        u = y(u, l, p, d, r[h + 9], 4, -640364487),
                        d = y(d, u, l, p, r[h + 12], 11, -421815835),
                        p = y(p, d, u, l, r[h + 15], 16, 530742520),
                        u = x(u, l = y(l, p, d, u, r[h + 2], 23, -995338651), p, d, r[h + 0], 6, -198630844),
                        d = x(d, u, l, p, r[h + 7], 10, 1126891415),
                        p = x(p, d, u, l, r[h + 14], 15, -1416354905),
                        l = x(l, p, d, u, r[h + 5], 21, -57434055),
                        u = x(u, l, p, d, r[h + 12], 6, 1700485571),
                        d = x(d, u, l, p, r[h + 3], 10, -1894986606),
                        p = x(p, d, u, l, r[h + 10], 15, -1051523),
                        l = x(l, p, d, u, r[h + 1], 21, -2054922799),
                        u = x(u, l, p, d, r[h + 8], 6, 1873313359),
                        d = x(d, u, l, p, r[h + 15], 10, -30611744),
                        p = x(p, d, u, l, r[h + 6], 15, -1560198380),
                        l = x(l, p, d, u, r[h + 13], 21, 1309151649),
                        u = x(u, l, p, d, r[h + 4], 6, -145523070),
                        d = x(d, u, l, p, r[h + 11], 10, -1120210379),
                        p = x(p, d, u, l, r[h + 2], 15, 718787259),
                        l = x(l, p, d, u, r[h + 9], 21, -343485551),
                        u = u + g >>> 0,
                        l = l + b >>> 0,
                        p = p + E >>> 0,
                        d = d + v >>> 0
                    }
                    return n.endian([u, l, p, d])
                }
